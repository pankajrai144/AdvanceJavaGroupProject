            ...
            <div class="product-pagination">
                ...
                <c:choose>
                    <c:when test="${currentPage > 1}">
                        <a href="${pageContext.request.contextPath}/clubs?page=${currentPage - 1}" class="pagination-btn">
                            Previous
                        </a>
                    </c:when>
                ...
                <c:forEach begin="1" end="${totalPages}" var="pageNumber">
                    <c:choose>
                        ...
                        <c:otherwise>
                            <a href="${pageContext.request.contextPath}/clubs?page=${pageNumber}" class="pagination-number">
                                ${pageNumber}
                            </a>
                        </c:otherwise>
                    </c:choose>
