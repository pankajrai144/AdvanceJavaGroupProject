...
<head>
<meta charset="UTF-8">
<title>Access Denied | JerseyPasal</title>
...
<section class="error-page-section">
    <div class="error-box">
        ...
        <p>
            ...
            Please login with the correct account or return to your dashboard.
        </p>

        <div class="error-buttons">
            <a href="${pageContext.request.contextPath}/userdashboard" class="error-btn home-btn">Dashboard</a>
