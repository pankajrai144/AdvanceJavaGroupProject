  ...
  <div class="team-grid">
    <div class="team-card fade-up">
      ...
      <div class="team-info">
        ...
        <span class="team-role">Backend Engineer &amp; Frontend Developer</span>
    ...
    <div class="team-card fade-up">
      <div class="team-avatar-wrap">
         <img src="${pageContext.request.contextPath}/images/pankaj.jpg" alt="Pankaj Rai">
      </div>
      <div class="team-info">
        <h4>Pankaj Rai</h4>
    ...
    <div class="team-card fade-up">
      ...
      <div class="team-info">
        <h4>Kritee Khadka</h4>
        <span class="team-role">Frontend Developer &amp; UI/UX Design</span>
...
<footer>
  ...
  <p>©️ 2025 Jersey Pasal. All rights reserved. Nepal's Home of Authentic Jerseys.</p>
</footer>
